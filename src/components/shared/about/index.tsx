...
export const AboutUs = () => {
  return (
    <section id="aboutUs" className="py-16 md:py-20 bg-background global-padding-container">
        ...
        <div >
          ...
          <div className="mt-6 space-y-6">
            {[
              ...
              <div key={idx}>
                <Typography variant="Regular_H6" className="block  text-foreground">
                  {item}
                </Typography>
              </div>
            ))}
          ...
          <div className="mt-6 md:mt-8 flex gap-x-6 md:gap-x-8 ">
            <Button variant="primary" className="w-[180px]">Explore</Button>
            <Button variant="secondary" className="w-[180px]">Explore</Button>
          </div>
        </div>
      </div>
    </section>
